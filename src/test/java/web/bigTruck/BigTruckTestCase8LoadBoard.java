...
//        $(".load-info-modal-dialog .close").shouldBe(enabled).click();
        ...
        //перевіряє водія та трак перед редагуванням водія
        ...
        //перевіряє дані водія в фрейм Dispatch
        ...
        //перевіряє дані dispatch при створенні вантажу
        $("#select2-carrierId-container").shouldHave(text("AutoTestOwner1 INC"));
