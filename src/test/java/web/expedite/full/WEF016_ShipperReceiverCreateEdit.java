...
public class WEF016_ShipperReceiverCreateEdit {
    ...
    //створює та редагує Destination Shippers
        ...
        //перевіряє додавання створеного Destination Shipper на фреймі New Load
        Thread.sleep(4000);
    ...
    //редагує Destination Shipper
        ...
        //генерує дані для редагування Destination Shipper
