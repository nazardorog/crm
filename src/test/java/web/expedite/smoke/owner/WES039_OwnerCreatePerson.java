...
public class WES039_OwnerCreatePerson {
    ...
    public void createPerson() {
        ...
        SelenideElement rowLoad = $$("table.table-striped tbody tr").get(0).shouldHave(text(atFirstName));
